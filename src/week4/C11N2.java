...
public class C11N2 {
    ...
    public C11N2(String name, String address, String phone, String email) {
        this.name = name;
    ...
    public String toString() {
        return "C11N2{" + "name=" + name + ", address=" + address + ", phone=" + phone + ", email=" + email + '}';
    }
}

class Student extends C11N2 {
...
class C11N2Test {
    ...
    public static void main(String[] args) {
        C11N2 p1 = new C11N2("Joe", "123 Main", "123-4567", "test@ex.com");
